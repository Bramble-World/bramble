...
const unsentApology: StoryBeat[] = [
  ...
  },
  {
    ...
    choices: choices([
      'Ask what changed',
      "Admit you've been waiting",
      "Tell her you're tired of this",
    ]),
  },
  {
...
const threeDaysOfMaybe: StoryBeat[] = [
  {
    ...
    choices: choices([
      'Ask what they decided',
      'Play it cool',
      'Tell them what you actually meant',
    ]),
  },
  {
...
const theAsk: StoryBeat[] = [
  {
    ...
    choices: choices([
      'Say yes and wait',
      "Ask what it's about first",
      'Make your case before the meeting',
    ]),
  },
  {
...
const theLongEmail: StoryBeat[] = [
  {
    ...
    incomingMessage:
      'I am not writing to ask you for anything. I want to be clear about that first.',
    incomingEmail: {
    ...
    choices: choices([
      'Reply before you lose your nerve',
