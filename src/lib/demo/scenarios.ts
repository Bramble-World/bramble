...
const unsentApology: Scenario = {
  ...
  history: [
    {
      isFromMe: false,
      text: "i just don't think you actually hear me when i'm talking",
      timestamp: 'Tue 11:42 PM',
    },
...
const threeDaysOfMaybe: Scenario = {
  ...
  stakes:
    'You asked something close to a real question and got a maybe. Then the thread went quiet.',
...
const operationBirthday: Scenario = {
  ...
  history: [
    ...
    {
      isFromMe: false,
      text: "we're doing something!! I already told aunt rosa",
    ...
    {
      isFromMe: false,
      text: 'she has already made a cake decision',
      timestamp: 'Yesterday 6:04 PM',
    },
...
const theAsk: Scenario = {
  ...
  history: [
    ...
    {
      isFromMe: false,
      text: 'I did. I want to give you a real answer rather than a fast one.',
      timestamp: 'Thu 6:48 PM',
    },
    {
      isFromMe: true,
      text: "That's fair. I just don't want it to slide into next quarter again.",
      timestamp: 'Thu 6:51 PM',
    },
    {
      isFromMe: false,
      text: 'Understood. Let me look at where we are on headcount.',
      timestamp: 'Thu 7:20 PM',
    },
    {
      isFromMe: true,
      text: "Appreciate it. I've been covering the role since March.",
      timestamp: 'Thu 7:22 PM',
    },
...
const slowFade: Scenario = {
  ...
  history: [
    ...
    {
      isFromMe: false,
      text: 'sorry for the slow reply, things have been mad',
      timestamp: '3 weeks ago',
    },
    {
      isFromMe: true,
      text: 'all good. we should actually catch up properly at some point',
      timestamp: '3 weeks ago',
    },
    {
      isFromMe: false,
      text: "yes 100%. let me get through this month and I'll text you",
      timestamp: '3 weeks ago',
    },
  ],
};
