    ...
    <div className="@container w-full">
      ...
      >
        ...
        <div style={{ padding: PAD, paddingBottom: 0 }}>
          <h2 className="leading-tight font-semibold text-black" style={{ fontSize: TYPE.subject }}>
            {threadTitle(emails)}
          </h2>
        ...
        <div style={{ padding: PAD, display: 'flex', flexDirection: 'column' }}>
          ...
          {latest && <ExpandedEmail personaName={personaName} portrait={portrait} email={latest} />}
...
function CollapsedRow({
  ...
  return (
    ...
    >
      ...
      />
      <span className="shrink-0 font-medium text-black/60" style={{ fontSize: TYPE.meta }}>
        {name}
      </span>
