...
function Wifi() {
  return (
    <svg viewBox="0 0 16 12" style={{ width: "5cqw" }} fill="none" stroke="currentColor" aria-hidden>
...
function Battery() {
  return (
    <svg viewBox="0 0 26 12" style={{ width: "7.5cqw" }} aria-hidden>
      <rect x="0.5" y="0.5" width="22" height="11" rx="3.2" fill="none" stroke="currentColor" opacity="0.5" />
...
function NotificationCard({
  ...
  return (
    <div
      className="flex items-start [animation:bramble-rise_300ms_ease-out]"
      style={{
        gap: "3cqw",
        padding: "3.5cqw",
        borderRadius: "6.2cqw",
    ...
    >
      ...
      <div className="flex min-w-0 flex-1 flex-col" style={{ gap: "0.8cqw" }}>
        <div className="flex items-baseline justify-between" style={{ gap: "2cqw" }}>
          <span className="font-semibold uppercase text-white" style={{ fontSize: "4.3cqw" }}>
            {contactName}
          </span>
